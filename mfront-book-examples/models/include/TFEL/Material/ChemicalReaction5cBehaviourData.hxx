/*!
* \file   TFEL/Material/ChemicalReaction5cBehaviourData.hxx
* \brief  this file implements the ChemicalReaction5cBehaviourData class.
*         File generated by tfel version 4.1.0-dev
* \author Thomas Helfer
* \date   09 / 07 / 2022
 */

#ifndef LIB_TFELMATERIAL_CHEMICALREACTION5C_BEHAVIOUR_DATA_HXX
#define LIB_TFELMATERIAL_CHEMICALREACTION5C_BEHAVIOUR_DATA_HXX
...
class ChemicalReaction5cBehaviourData;

//! \brief forward declaration
template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType,bool use_qt>
class ChemicalReaction5cIntegrationData;

//! \brief forward declaration
template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType, bool use_qt>
std::ostream&
 operator <<(std::ostream&,const ChemicalReaction5cBehaviourData<hypothesis, NumericType, use_qt>&);
...
friend std::ostream& operator<< <>(std::ostream&,const ChemicalReaction5cBehaviourData&);

/* integration data is declared friend to access   driving variables at the beginning of the time step */
friend class ChemicalReaction5cIntegrationData<hypothesis, NumericType, use_qt>;
...
#line 9 "/home/th202608/Documents/Books/MFrontBook/examples/models/ChemicalReaction5c.mfront"
tfel::math::quantity<numeric_type,0,0,0,0,0,0,1> ca;
#line 12 "/home/th202608/Documents/Books/MFrontBook/examples/models/ChemicalReaction5c.mfront"
...
*/
ChemicalReaction5cBehaviourData()
{}

/*!
* \brief copy constructor
*/
ChemicalReaction5cBehaviourData(const ChemicalReaction5cBehaviourData& src)
: ca(src.ca),
cb(src.cb),
T(src.T)
{}
 ...
 */
ChemicalReaction5cBehaviourData(const mfront::gb::BehaviourData& mgb_d)
...
*/
ChemicalReaction5cBehaviourData&
operator=(const ChemicalReaction5cBehaviourData& src){
this->ca = src.ca;
this->cb = src.cb;
this->T = src.T;
return *this;
...
}; // end of ChemicalReaction5cBehaviourDataclass

template<ModellingHypothesis::Hypothesis hypothesis,typename NumericType, bool use_qt>
std::ostream&
operator <<(std::ostream& os,const ChemicalReaction5cBehaviourData<hypothesis, NumericType, use_qt>& b)
{
os << "ca : " << b.ca << '\n';
os << "cb : " << b.cb << '\n';
os << "T : " << b.T << '\n';
...
#endif /* LIB_TFELMATERIAL_CHEMICALREACTION5C_BEHAVIOUR_DATA_HXX */
