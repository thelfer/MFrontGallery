/*!
* \file   TFEL/Material/ChemicalReaction5dIntegrationData.hxx
* \brief  this file implements the ChemicalReaction5dIntegrationData class.
*         File generated by tfel version 4.1.0-dev
* \author Thomas Helfer
* \date   09 / 07 / 2022
 */

#ifndef LIB_TFELMATERIAL_CHEMICALREACTION5D_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_CHEMICALREACTION5D_INTEGRATION_DATA_HXX
...
template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType, bool use_qt>
std::ostream&
 operator <<(std::ostream&,const ChemicalReaction5dIntegrationData<hypothesis, NumericType, use_qt>&);
...
friend std::ostream& operator<< <>(std::ostream&,const ChemicalReaction5dIntegrationData&);
...
*/
ChemicalReaction5dIntegrationData()
{}

/*!
* \brief Copy constructor
*/
ChemicalReaction5dIntegrationData(const ChemicalReaction5dIntegrationData& src)
: dt(src.dt),
dT(src.dT)
{}
 ...
 */
ChemicalReaction5dIntegrationData(const mfront::gb::BehaviourData& mgb_d)
: dt(mgb_d.dt),
...
ChemicalReaction5dIntegrationData&
>::type
scale(const ChemicalReaction5dBehaviourData<hypothesis, NumericType, use_qt>&, const Scal time_scaling_factor){
...
*/
ChemicalReaction5dIntegrationData&
updateDrivingVariables(const ChemicalReaction5dBehaviourData<hypothesis, NumericType, use_qt>&){
return *this;
}

}; // end of ChemicalReaction5dIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType,bool use_qt>
std::ostream&
operator <<(std::ostream& os,const ChemicalReaction5dIntegrationData<hypothesis, NumericType, use_qt>& b)
{
os << "Δt : " << b.dt << '\n';
os << "ΔT : " << b.dT << '\n';
return os;
...
#endif /* LIB_TFELMATERIAL_CHEMICALREACTION5D_INTEGRATION_DATA_HXX */
