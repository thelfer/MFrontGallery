function(mfront_query res mat search_paths source )
  if(${ARGC} LESS 1)
    message(FATAL_ERROR "mfront_query: no query specified")
  endif(${ARGC} LESS 1)
  ...
  if( query_result EQUAL 0 )
    ...
    message(WARNING "mfront_query: call to mfront-query failed for ${source} (${MFRONT_QUERY} ${mfront_query_args})")
  endif( query_result EQUAL 0 )
endfunction(mfront_query)
