...
macro(mfront_properties_extension ext interface)
...
endmacro(mfront_properties_extension)
...
macro(mfront_properties_standard_library mat interface)
  ...
  mfront_properties_extension(ext ${interface})
  foreach(source ${ARGN})
    if("${ext}" STREQUAL "")
      add_mfront_property_source(${lib} ${mat} ${interface} "" ${source})
    else("${ext}" STREQUAL "")
      add_mfront_property_source(${lib} ${mat} ${interface} ${ext} ${source})
    endif("${ext}" STREQUAL "")
  endforeach(source)
