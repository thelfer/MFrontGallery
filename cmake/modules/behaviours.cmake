...
function(add_mfront_behaviour_source lib mat interface search_paths path)
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${path}.mfront.in")
    set(mfront_path   "${CMAKE_CURRENT_BINARY_DIR}/${path}.mfront")
    configure_file(
      "${CMAKE_CURRENT_SOURCE_DIR}/${path}.mfront.in"
      "${CMAKE_CURRENT_BINARY_DIR}/${path}.mfront"
      @ONLY)
  elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${path}.mfront")
    set(mfront_path   "${CMAKE_CURRENT_SOURCE_DIR}/${path}.mfront")
  else(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${path}.mfront.in")
    message(FATAL_ERROR "add_mfront_behaviour_source: unsupported path '${path}'")
  endif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${path}.mfront.in")
  ...
  if(file_OK)
    ...
    list(TRANSFORM mfront_generated_sources
	 ...
	 ist(APPEND ${lib}_SOURCES ${mfront_generated_sources})
    list(REMOVE_DUPLICATES ${lib}_SOURCES)
	 ist(APPEND ${lib}_MFRONT_SOURCES ${mfront_path})
    ...
    set(msg "${path} has been discarded for interface ${interface}")
...
function(add_mfront_behaviour_sources lib mat interface search_paths file)
  ...
  add_mfront_behaviour_source(${lib} ${mat} ${interface} "${search_paths}" ${file})
...
#        	list(APPEND ${mfront_behaviour_library_name}_OTHER_SOURCES
