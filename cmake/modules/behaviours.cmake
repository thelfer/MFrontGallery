...
function(add_mfront_behaviour_sources lib mat interface search_paths file)
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${file}.mfront.in")
    ...
    configure_file(
      ...
      @ONLY)
  elif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${file}.mdnx")
    set(mfront_file "${CMAKE_CURRENT_SOURCE_DIR}/${file}.mdnx")
  elif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${file}.madnex")
    set(mfront_file "${CMAKE_CURRENT_SOURCE_DIR}/${file}.madnex")
  elif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${file}.mfront")
    set(mfront_file "${CMAKE_CURRENT_SOURCE_DIR}/${file}.mfront")
  else(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${file}.mfront.in")
    list(APPEND ${lib}_SOURCES ${file})
  ...
  foreach(interface ${mfront-behaviours-interfaces})
    ...
    foreach(source ${mfront_sources})
      ...
      elseif(EXISTS "${CMAKE_CURRENT_BINARY_DIR}/${source}")
        	list(APPEND ${mfront_behaviour_library_name}_OTHER_SOURCES  "${CMAKE_CURRENT_SOURCE_DIR}/${source}")
