...
#    list(APPEND mfront_query_args "--material=${mat}")
    if(${kind} STREQUAL "material-property")
      list(APPEND mfront_query_args "--material-property=.+")
    elseif(${kind} STREQUAL "behaviour")
      list(APPEND mfront_query_args "--behaviour=.+")
    elseif(${kind} STREQUAL "model")
      list(APPEND mfront_query_args "--model=.+")
